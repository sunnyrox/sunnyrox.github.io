...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.data.isLogin = this.name === null ? false : true;
...
/* harmony import */ var _pages_user_warehouse_warehouse_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pages/user/warehouse/warehouse.component */ "./src/app/pages/user/warehouse/warehouse.component.ts");
/* harmony import */ var _pages_user_information_information_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./pages/user/information/information.component */ "./src/app/pages/user/information/information.component.ts");
/* harmony import */ var _components_login_login_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/login/login.component */ "./src/app/components/login/login.component.ts");
/* harmony import */ var _components_card_domand_card_domand_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/card-domand/card-domand.component */ "./src/app/components/card-domand/card-domand.component.ts");
/* harmony import */ var _components_card_need_card_need_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/card-need/card-need.component */ "./src/app/components/card-need/card-need.component.ts");
/* harmony import */ var _components_card_my_card_my_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/card-my/card-my.component */ "./src/app/components/card-my/card-my.component.ts");
/* harmony import */ var _pages_production_product_product_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./pages/production/product/product.component */ "./src/app/pages/production/product/product.component.ts");
/* harmony import */ var _pages_production_demand_demand_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./pages/production/demand/demand.component */ "./src/app/pages/production/demand/demand.component.ts");
...
/* harmony import */ var _components_title_title_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/title/title.component */ "./src/app/components/title/title.component.ts");
/* harmony import */ var _components_recommend_recommend_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/recommend/recommend.component */ "./src/app/components/recommend/recommend.component.ts");
/* harmony import */ var _pages_production_product_detail_product_detail_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./pages/production/product-detail/product-detail.component */ "./src/app/pages/production/product-detail/product-detail.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _pages_user_warehouse_warehouse_component__WEBPACK_IMPORTED_MODULE_7__["WarehouseComponent"],
                _pages_user_information_information_component__WEBPACK_IMPORTED_MODULE_8__["InformationComponent"],
                _components_login_login_component__WEBPACK_IMPORTED_MODULE_9__["LoginComponent"],
                _components_card_domand_card_domand_component__WEBPACK_IMPORTED_MODULE_10__["CardDomandComponent"],
                _components_card_need_card_need_component__WEBPACK_IMPORTED_MODULE_11__["CardNeedComponent"],
                _components_card_my_card_my_component__WEBPACK_IMPORTED_MODULE_12__["CardMyComponent"],
                _pages_production_product_product_component__WEBPACK_IMPORTED_MODULE_13__["ProductComponent"],
                _pages_production_demand_demand_component__WEBPACK_IMPORTED_MODULE_14__["DemandComponent"],
                _components_board_board_component__WEBPACK_IMPORTED_MODULE_15__["BoardComponent"],
                _components_title_title_component__WEBPACK_IMPORTED_MODULE_16__["TitleComponent"],
                _components_recommend_recommend_component__WEBPACK_IMPORTED_MODULE_17__["RecommendComponent"],
                _pages_production_product_detail_product_detail_component__WEBPACK_IMPORTED_MODULE_18__["ProductDetailComponent"]
            ],
...
var CardDomandComponent = /** @class */ (function () {
    function CardDomandComponent(router, data) {
        this.router = router;
        this.data = data;
    }
    CardDomandComponent.prototype.ngOnInit = function () { };
    CardDomandComponent.prototype.toDetail = function () {
        // this.data.product = this.item;
        localStorage.setItem("productID", this.item.ID);
        this.router.navigate(["/product/detail"]);
        window.location.reload();
    };
    CardDomandComponent.ctorParameters = function () { return [
...
var CardMyComponent = /** @class */ (function () {
    function CardMyComponent() {
    }
    CardMyComponent.prototype.ngOnInit = function () {
    };
...
var CardNeedComponent = /** @class */ (function () {
    function CardNeedComponent() {
    }
    CardNeedComponent.prototype.ngOnInit = function () {
    };
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        var user = this.data.accountList.find(function (item) {
...
var ProductDetailComponent = /** @class */ (function () {
    ...
    ProductDetailComponent.prototype.ngOnInit = function () {
        if (localStorage.getItem("productID")) {
            this.product = this.data.stockInfo.find(function (item) {
                return item.ID.toString() === localStorage.getItem("productID");
            });
        }
        console.log(this.product);
    };
    ProductDetailComponent.prototype.check = function () {
        if (confirm("確認要領取物資？")) {
